...
public class TopRatedMoviesFragment extends Fragment implements MovieAdapter.MovieAdapterOnclickHandler {
    ...
    private void observeData(){
        ...
        masterActivityViewModel.getTopRatedMovies().observe(this, movies -> {
