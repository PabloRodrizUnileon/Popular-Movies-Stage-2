package com.example.pablo.popularmovies.SharedPreferences;
 ...
 * Usage:
 *
 * int sampleInt = MySharedPreferences.getInstance(context).getInt(Key.SAMPLE_INT);
 * MySharedPreferences.getInstance(context).set(Key.SAMPLE_INT, sampleInt);
 *
 * If MySharedPreferences.getInstance(Context) has been called once, you can
 * simple use MySharedPreferences.getInstance() to save some precious line space.
 */
public class MySharedPreferences {

    private static final String SETTINGS_NAME = "shared_preferences_popular_movies";
    ...
    public enum Key {
         ...
         */
        LAST_TIME_DATABASE_UPDATE_LONG,
        SAMPLE_INT
    }
